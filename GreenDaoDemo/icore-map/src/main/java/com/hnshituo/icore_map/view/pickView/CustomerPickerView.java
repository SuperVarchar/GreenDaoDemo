 ...
 */
public class CustomerPickerView<T> extends BasePickerView implements View.OnClickListener {

    PickViewOptions<T> wheelOptions;
    ...
    public CustomerPickerView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.layout_picker_view, contentContainer);
        // -----确定和取消按钮
        ...
        wheelOptions = new PickViewOptions<T>(optionspicker);
    }
    ...
    public void setCancelVisibility(boolean isVisibility){
        if(isVisibility){
