 ...
 */
public class PickViewOptions<T> {
    private View view;
    private com.bigkoo.pickerview.lib.WheelView wv_option1;
    private com.bigkoo.pickerview.lib.WheelView wv_option2;
    private com.bigkoo.pickerview.lib.WheelView wv_option3;
    ...
    public PickViewOptions(View view) {
        super();
        this.view = view;
        setView(view);
    }
    ...
    public void setPicker(ArrayList<T> options1Items,
        ...
        if (this.mOptions2Items == null)
            len = 12;
        // 选项1
        wv_option1 = (com.bigkoo.pickerview.lib.WheelView) view.findViewById(com.bigkoo.pickerview.R.id.options1);
        wv_option1.setAdapter(new ArrayWheelAdapter(mOptions1Items, len));// 设置显示数据
        wv_option1.setCurrentItem(0);// 初始化时显示的数据
        // 选项2
        wv_option2 = (com.bigkoo.pickerview.lib.WheelView) view.findViewById(com.bigkoo.pickerview.R.id.options2);
        ...
        // 选项3
        wv_option3 = (com.bigkoo.pickerview.lib.WheelView) view.findViewById(com.bigkoo.pickerview.R.id.options3);
