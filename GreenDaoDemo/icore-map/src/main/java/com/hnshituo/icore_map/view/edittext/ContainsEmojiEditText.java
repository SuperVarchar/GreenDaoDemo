...
/**
 * Created by liuba
 * time:2017/3/24 14:15
 * describe --限制输入表情的Edittext
 */
...
//                            Toast.makeText(mContext, "不支持输入表情符号！", Toast.LENGTH_SHORT).show();
                            MyToast.show(mContext, "不支持输入表情符号");
                            ...
                            if (mChanged != null) {
                                mChanged.changed(inputAfterText.length());
                            }
                        }else {
                            if(mChanged != null){
                                mChanged.changed(s.length());
                            }
                        }
                    }else {
                        if(mChanged != null){
